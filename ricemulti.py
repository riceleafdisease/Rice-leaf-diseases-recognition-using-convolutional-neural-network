...
data=[]
label_list = []
for filename in glob.glob('Ricedataset/train/*/*.jpg'):
...
data1=[]
label_list1 = []
for filename in glob.glob('Ricedataset/validation/*/*.jpg'):
   # print(os.path.basename(filename))
...
data2=[]
label_list2 = []
for filename in glob.glob('Ricedataset/test/*/*.jpg'):
    #print(os.path.basename(filename))
...
target_names = [ 'Bacterial Leaf Blight', 'Blast','Brownspot','Sheath Blight','Tungro']
...
img = load_img('Ricedataset/test/Brownspot/Brownspot_6_output.jpg', target_size=(256, 256))
...
if classes1==0:
    ...
    print('Predicted class is: Bacterial Leaf Blight')
elif classes1==2:
    print('Predicted class is: Brownspot')
elif classes1==3:
    print('Predicted class is: Sheath Blight')
else:
    print('Predicted class is: Tungro')
...
lw=lw, label='ROC curve of Bacterial Leaf Blight (area = %0.2f)' % roc_auc[1])
plt.plot(fpr[2], tpr[2], color='cornflowerblue',
lw=lw, label='ROC curve of Brownspot (area = %0.2f)' % roc_auc[2])
plt.plot(fpr[3], tpr[3], color='red',
lw=lw, label='ROC curve of Sheath Blight (area = %0.2f)' % roc_auc[3])
plt.plot(fpr[4], tpr[4], color='green',
lw=lw, label='ROC curve of Tungro (area = %0.2f)' % roc_auc[4])
